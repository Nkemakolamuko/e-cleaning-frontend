...
const AdminHeader = () => {
  ...
  return (
    <div
      className={`header relative z-40 top-0 w-full border-b flex items-center justify-between h-fit text-slate-500 over ${
        sidebar && "truncate"
      }`}
    >
      <div className="flex items-center gap-4 w-full">
        ...
        <div className="flex items-center justify-between border rounded w-full bg-white">
          <input
            type="text"
            className="py-2 md:py-2 px-2 bg-inherit w-full outline-none rounded"
