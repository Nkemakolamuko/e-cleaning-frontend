...
const ProductSummary = () => {
  return (
    <div className="max-w-full flex-col flex items-center justify-between h-[200px] overflow-auto md:overflow-hidden md:hover:overflow-auto transition-all duration-300 ease-in-out">
      ...
      <div className="flex items-center justify-between w-full mt-8 bg-slate-100 p-2 rounded-md transition-all duration-300">
        ...
        <p className="font-medium tracking-widest">N 62,999.99</p>
      </div>
