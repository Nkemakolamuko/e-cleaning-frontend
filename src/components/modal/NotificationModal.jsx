...
const NotificationModal = ({ handleCloseNotificationModal }) => {
  return (
    <div className="max-w-fit h-fit bg-white flex items-center flex-col justify-center absolute top-2 right-16 z-50 shadow-lg shadow-black/20 rounded p-2 transition-all duration-300">
