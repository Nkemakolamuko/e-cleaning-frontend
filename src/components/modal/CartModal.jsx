...
const CartModal = ({ handleModalClose }) => {
  ...
  return (
    <div className="max-w-fit h-fit bg-white flex items-center flex-col justify-center absolute top-2 right-2 md:right-8 z-[999] shadow-lg shadow-black/20 rounded p-2 transition-all duration-300">
      ...
      {cartModalCount < 2 ? (
        <div className="px-4 py-6 flex flex-col w-full bg-white my-[10px] mx-[55px] md:my-[100px] text-center justify-center md:mx-[230px]">
        ...
        <>
          <div className="pb-3 pt-1 md:py-4 flex flex-col w-full bg-white mx-[70px] md:mx-[230px]">
            <ProductSummary />
          </div>
