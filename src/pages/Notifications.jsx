  ...
  return (
    <div>
      ...
      <div className="w-full flex items-center justify-center">
        <div
          className={`flex items-center fixed justify-between text-slate-500 bottom-0 w-full md:w-[50%] bg-white cursor-pointer border-2 md:rounded-md text-sm transition-all duration-300 ${
        ...
        >
          ...
          <p
            className={`flex flex-col items-center px-2 py-2 md:py-3 w-[50%] bg-slate-100 hover:bg-slate-200 border-l-2 hover:text-slate-800 md:rounded-r-md transition-all duration-300 ${
              darkMode ? "dark-mode border-l-2" : ""
            }`}
          >
